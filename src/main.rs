...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    let ship_handle = asset_server.load("simplespace/ship_C.png");
    let enemy_a_handle = asset_server.load("simplespace/enemy_A.png");
    let enemy_b_handle = asset_server.load("simplespace/enemy_B.png");
